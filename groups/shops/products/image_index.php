<?php 
	...
	$image = $model->where("pro_id={$_GET['pro_id']}")->select();
 ?>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-12">
								<a href="image_add.php?pro_id=<?=$_GET['pro_id']?>" class="btn btn-success">
									添加图片
								</a>
								<br><br>
									...
									<tbody>
										<?php foreach ($image as $key => $value): ?>
											<tr>
												...
												<td><img src="../images/<?=$value['image_name']?>" width="150px"></td>
												<td><?=date("Y-m-d H:i:s",$value['image_addtime'])?></td>
												<td>
													<a href="action.php?a=imagedelete&image_id=<?=$value['image_id']?>&pro_id=<?=$value['pro_id']?>&image_name=<?=$value['image_name']?>" class="btn btn-danger">
														删除
													</a>
													<a href="image_edit.php?image_id=<?=$value['image_id']?>&pro_id=<?=$value['pro_id']?>" class="btn btn-success">
														修改
													</a>
												</td>
											</tr>
