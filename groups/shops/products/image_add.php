			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-6">
								<form role="form" action="action.php?a=addimage" method="POST" enctype="multipart/form-data" multiple>
								  <div class="form-group">
								    <label for="image_name">图片名称</label>
								    <input type="text" class="form-control" id="image_name" placeholder="图片名称" name="image_name">
								  </div>
								  <div class="form-group">
									  <label for="imagefile">选择文件</label>
									  <input type="file" class="form-control" id="imagefile" name="images">
								  </div>
								  <input type="text" hidden name="pro_id" value="<?=$_GET['pro_id']?>">
