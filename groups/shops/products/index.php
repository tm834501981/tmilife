<?php 
	...
	$product = $model->limit($page->firstRow,$page->listRows)->order('pro_addtime desc,pro_id desc')->select();
									...
									<tbody>
										<?php foreach ($product as $key => $value): ?>
											<tr>
												...
												<td><?=$value['pro_oldprice']?></td>
												<td><?=$value['pro_number']?></td>
												<td><?=$value['pro_desc']?></td>
												<td><?=date("Y-m-d H:i:s",$value['pro_addtime'])?></td>
												<td>
													<a href="action.php?a=delete&pro_id=<?=$value['pro_id']?>&page=<?=$indexPage?>" class="btn btn-danger">
														删除
													</a>
													<a href="edit.php?pro_id=<?=$value['pro_id']?>&page=<?=$indexPage?>" class="btn btn-success">
														修改
													</a>
													<br> <br>
													<a href="image_index.php?pro_id=<?=$value['pro_id']?>" class="btn btn-success">
														管理商品的图片
													</a>
												</td>
											</tr>
