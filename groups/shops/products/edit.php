			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-6">
								<form role="form" action="action.php?a=edit" method="POST">
								  <div class="form-group">
								    <label for="pro_name">商品名称</label>
								    <input type="text" class="form-control" id="pro_name" placeholder="商品名称" name="pro_name" value='<?=$data["pro_name"]?>'>
								  </div>
								  <div class="form-group">
								    <label for="pro_price">商品价格</label>
								    <input type="text" class="form-control" id="pro_price" placeholder="商品价格" name="pro_price" value='<?=$data["pro_price"]?>'>
								  </div>
								  <div class="form-group">
								    <label for="pro_oldprice">商品原价</label>
								    <input type="text" class="form-control" id="pro_oldprice" placeholder="商品原价" name="pro_oldprice" value='<?=$data["pro_oldprice"]?>'>
								  </div>
								  <div class="form-group">
								    <label for="pro_number">商品数量</label>
								    <input type="text" class="form-control" id="pro_number" placeholder="商品价格" name="pro_number" value='<?=$data["pro_number"]?>'>
								  </div>
								  <div class="form-group">
								    <label for="pro_desc">商品描述</label>
								    <textarea name="pro_desc" id="pro_desc" cols="30" rows="10"><?=$data["pro_desc"]?></textarea>
								  </div>
									<input type="text" hidden name="pro_id" value="<?=$data["pro_id"]?>">
									<input type="text" hidden name="page" value="<?=$editPage?>">
...
<![endif]-->
		...
		<script src="<?=URL?>assets/js/jquery.easy-pie-chart.min.js"></script>
