...
<?php 
	...
	$model = new Model("s_image");
	$imagedata = $model->find($_GET['image_id']);
	$indexpre = $imagedata['image_name'];
	$index = strrpos($indexpre,'.');
	$indexcut = substr($indexpre,0,$index);
 ?>
<!DOCTYPE html>
<html lang="en">
	<head>
			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-md-6">
								<form role="form" action="action.php?a=editimage" method="POST" enctype="multipart/form-data" multiple>
								  <div class="form-group">
								    <label for="image_name">图片名称</label>
								    <input type="text" class="form-control" id="image_name" placeholder="图片名称" name="image_name" value="<?=$indexcut?>" required  >
								  </div>
								  <div>
								  	<img src="../images/<?=$imagedata['image_name']?>" alt="" width="200px">
								  </div>
								   <div class="form-group">
									  <label for="imageeditfile">选择文件</label>
									  <input type="file" class="form-control" id="imageeditfile" name="imageedit">
								  </div>
								  <input type="text" hidden value="<?=$imagedata['image_id']?>" name="image_id">
								  <input type="text" hidden value="<?=$_GET['pro_id']?>" name="pro_id">
